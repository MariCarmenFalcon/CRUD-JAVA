 ...
 * Realiza operaciones CRUD, especialmente consultas SELECT en las tablas "tb_mcye_dvds" y "tb_mcye_ventas".
 * </p>
 * 
...
public class Ejercicio5_Consulta {

	//CONSULTA (SELECT)
	static final String DB_URL = "jdbc:mysql://localhost:3306/bbdd_maricarmenyestrella_Music";
	static final String USER = "root";
	static final String PASS = "";
	static final String QUERYDvd = "SELECT * FROM tb_mcye_dvds";
	static final String QUERYVentas = "SELECT * FROM tb_mcye_ventas";
